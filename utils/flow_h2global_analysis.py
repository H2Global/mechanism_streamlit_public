...
def get_fiscal_npv(
    ...
    if PRODUCT_TYPE == "Ammonia":
        ...
        st.write("SHARE_NH3_FERTILIZER_DOMESTIC:", SHARE_NH3_FERTILIZER_DOMESTIC)
        st.write("FERTILIZER_PER_KG_NH3:", FERTILIZER_PER_KG_NH3)
        st.write("FERTILIZER_SALES_PRICE:", FERTILIZER_SALES_PRICE)
        st.write("SHARE_DOMESTIC_SALES_FERTILIZER:", SHARE_DOMESTIC_SALES_FERTILIZER)
